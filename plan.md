...
|---|---------|--------|---------|---------|------|
| 001 | 2048 | 2048 | 滑動合併數字達到2048 | Vanilla JS + CSS Grid | ⬜ |
| 002 | 俄羅斯方塊 | Tetris | 旋轉排列方塊消除行列 | Canvas 2D | ⬜ |
| 003 | 數獨 | Sudoku | 9x9填數邏輯推理 | React + SVG | ⬜ |
| 004 | 掃雷 | Minesweeper | 推理避開地雷 | Vanilla JS + DOM | ⬜ |
| 005 | 拼圖 | Jigsaw Puzzle | 拖曳拼合圖片 | Canvas + Drag API | ⬜ |
| 006 | 華容道 | Klotski | 滑動方塊讓曹操脫困 | Canvas 2D | ⬜ |
| 007 | 推箱子 | Sokoban | 推動箱子到目標點 | Phaser 3 | ⬜ |
...
| 013 | 數織 | Nonogram | 根據數字填格邏輯 | React + Grid | ⬜ |
| 014 | 七巧板 | Tangram | 拼合幾何圖形 | SVG + Drag | ⬜ |
| 015 | 魔術方塊 | Rubik's Cube | 3D還原六面同色 | Three.js | ⬜ |
