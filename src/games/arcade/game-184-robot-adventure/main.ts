/**
 * Robot Adventure Main Entry
 * Game #184
 */
import { RobotAdventureGame } from "./game";
...
function initGame() {
  game = new RobotAdventureGame(canvas);
  game.resize();
...
function showComplete() {
  setTimeout(() => {
    ...
    overlayMsg.textContent = `${i18n.t("game.coins")}: ${coinsDisplay.textContent}`;
