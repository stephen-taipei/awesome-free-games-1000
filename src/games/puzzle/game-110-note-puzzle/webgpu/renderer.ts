...
export class WebGPURenderer {
  ...
  // Effect methods
  public emitNoteClick(x: number, y: number, pitch?: number): void {
    this.particleSystem.emitNoteClick(x, y, pitch);
  }

  public emitMelody(x: number, y: number): void {
    this.particleSystem.emitMelody(x, y);
  }

  public emitChord(x: number, y: number): void {
    this.particleSystem.emitChord(x, y);
  }
