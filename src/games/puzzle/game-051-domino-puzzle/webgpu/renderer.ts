...
export class WebGPURenderer {
  ...
  render(): void {
    ...
    const bgPass = encoder.beginRenderPass({
      colorAttachments: [{
        view: textureView,
        clearValue: { r: 0.08, g: 0.25, b: 0.14, a: 1 },
        loadOp: 'clear',
        storeOp: 'store',
      }],
    });
