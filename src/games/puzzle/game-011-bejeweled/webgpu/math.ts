/**
 * WebGPU Math Utilities - Bejeweled
 * Game #011
 */
...
export const mat4 = {
  ...
  translate(out: Float32Array, a: Float32Array, v: number[]): Float32Array {
  ...
  scale(out: Float32Array, a: Float32Array, v: number[]): Float32Array {
    const x = v[0], y = v[1], z = v[2];
