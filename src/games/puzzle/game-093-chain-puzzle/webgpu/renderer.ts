...
export class WebGPURenderer {
  ...
  // Effect methods
  public emitRotation(x: number, y: number, rotation: number): void {
    this.particleSystem.emitRotation(x, y, rotation);
  }

  public emitUnlock(x: number, y: number): void {
    this.particleSystem.emitUnlock(x, y);
  }

  public emitLocked(x: number, y: number): void {
    this.particleSystem.emitLocked(x, y);
  }
