...
export class WebGPURenderer {
  ...
  private currentSeason: number = 0; // 0=spring, 1=summer, 2=autumn, 3=winter
  ...
  public emitAmbient(season: 'spring' | 'summer' | 'autumn' | 'winter'): void {
    this.particleSystem.emitAmbient(season);
  }
