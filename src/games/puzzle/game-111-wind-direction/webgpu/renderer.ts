/**
 * WebGPU Renderer - Wind Direction
...
export class WebGPURenderer {
  ...
  // Effect methods
  public emitWindClick(x: number, y: number, angle?: number): void {
    this.particleSystem.emitWindClick(x, y, angle);
  }

  public emitLeaf(x: number, y: number): void {
    this.particleSystem.emitLeaf(x, y);
  }
