/**
 * WebGPU Renderer - Temperature Balance
...
export class WebGPURenderer {
  ...
  public emitHot(x: number, y: number): void {
    this.particleSystem.emitHot(x, y);
  }

  public emitCold(x: number, y: number): void {
    this.particleSystem.emitCold(x, y);
  }

  public emitTransfer(fromX: number, fromY: number, toX: number, toY: number, isHotToCold: boolean): void {
    this.particleSystem.emitTransfer(fromX, fromY, toX, toY, isHotToCold);
  }
