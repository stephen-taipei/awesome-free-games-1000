...
export class WebGPURenderer {
  ...
  // Effect methods
  public emitSelect(x: number, y: number, hue?: number): void {
    this.particleSystem.emitSelect(x, y, hue);
  }

  public emitMix(x: number, y: number, hue1: number, hue2: number): void {
    this.particleSystem.emitMix(x, y, hue1, hue2);
  }
