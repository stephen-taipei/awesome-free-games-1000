...
export class WebGPURenderer {
  ...
  emitPlayerMove(fromX: number, fromY: number, toX: number, toY: number) {
    this.particleSystem.emitPlayerMove(fromX, fromY, toX, toY);
  }
  ...
  emitTeleport(
    ...
    this.particleSystem.emitTeleport(fromX, fromY, toX, toY, color);
  }

  // Wormhole idle
  emitWormholeIdle(x: number, y: number, color: number[]) {
    this.particleSystem.emitWormholeIdle(x, y, color);
  }
