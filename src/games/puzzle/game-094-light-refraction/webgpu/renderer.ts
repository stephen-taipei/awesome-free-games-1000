/**
 * WebGPU Renderer - Light Refraction
...
export class WebGPURenderer {
  ...
  // Effect methods
  public emitBeamPath(x1: number, y1: number, x2: number, y2: number, colorIndex: number): void {
    this.particleSystem.emitBeamPath(x1, y1, x2, y2, colorIndex);
  }

  public emitPrismHit(x: number, y: number, prismRotation: number): void {
    this.particleSystem.emitPrismHit(x, y, prismRotation);
  }

  public emitTargetHit(x: number, y: number): void {
    this.particleSystem.emitTargetHit(x, y);
  }

  public emitPrismMove(x: number, y: number, rotation: number): void {
    this.particleSystem.emitPrismMove(x, y, rotation);
  }
  ...
  public emitLevelStart(sourceX: number, sourceY: number): void {
    this.particleSystem.emitLevelStart(sourceX, sourceY);
    this.currentLevel++;
  }
