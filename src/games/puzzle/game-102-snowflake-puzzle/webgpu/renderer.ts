/**
 * WebGPU Renderer - Snowflake Puzzle
...
export class WebGPURenderer {
  ...
  private startRenderLoop(): void {
    const render = () => {
      ...
      this.particleSystem.emitAmbientSnow();
      this.render();
  ...
  public emitToggle(x: number, y: number, isActive: boolean): void {
    this.particleSystem.emitToggle(x, y, isActive);
  }

  public emitRotate(centerX: number, centerY: number, radius: number): void {
    this.particleSystem.emitRotate(centerX, centerY, radius);
  }

  public emitClear(centerX: number, centerY: number): void {
    this.particleSystem.emitClear(centerX, centerY);
  }

  public emitMatch(x: number, y: number): void {
    this.particleSystem.emitMatch(x, y);
  }
