...
export class WebGPURenderer {
  ...
  emitSlideStart(x: number, y: number) {
    this.particleSystem.emitSlideStart(x, y);
  }

  // Slide trail
  emitSlideTrail(fromX: number, fromY: number, toX: number, toY: number) {
    this.particleSystem.emitSlideTrail(fromX, fromY, toX, toY);
  }

  // Slide stop
  emitSlideStop(x: number, y: number) {
    this.particleSystem.emitSlideStop(x, y);
  }
