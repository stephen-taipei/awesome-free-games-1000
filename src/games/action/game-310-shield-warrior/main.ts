import { ShieldWarriorGame } from './game';
...
function initGame() {
  game = new ShieldWarriorGame(canvas);
  game.resize();
  game.setOnStateChange((state) => {
    ...
    staminaFill.classList.toggle('blocking', state.blocking);
...
['left', 'right', 'up', 'down', 'block', 'bash'].forEach(action => {
