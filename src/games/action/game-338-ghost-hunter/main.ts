/**
 * Ghost Hunter Main Entry
 * Game #338
 */
import { GhostHunterGame } from "./game";
...
const ectoDisplay = document.getElementById("ecto-display")!;
...
function initGame() {
  game = new GhostHunterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    ectoDisplay.textContent = state.ectoplasm.toString();
