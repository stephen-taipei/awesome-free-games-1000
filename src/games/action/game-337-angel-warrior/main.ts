/**
 * Angel Warrior Main Entry
 * Game #337
 */
import { AngelWarriorGame } from "./game";
...
const divineDisplay = document.getElementById("divine-display")!;
...
function initGame() {
  game = new AngelWarriorGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    divineDisplay.textContent = state.divine.toString();
