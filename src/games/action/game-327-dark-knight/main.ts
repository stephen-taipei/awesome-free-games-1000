/**
 * Dark Knight Main Entry
 * Game #327
 */
import { DarkKnightGame } from "./game";
...
function initGame() {
  game = new DarkKnightGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    powerDisplay.textContent = state.darkPower.toString();
