/**
 * Throwing Warrior Main Entry
 * Game #302
 */
import { ThrowingWarriorGame } from "./game";
...
function initGame() {
  game = new ThrowingWarriorGame(canvas);
  game.resize();
  ...
  document.addEventListener("keydown", (e) => {
    if (e.key === "1") game.selectWeapon("axe");
    if (e.key === "2") game.selectWeapon("spear");
    if (e.key === "3") game.selectWeapon("knife");
  });
