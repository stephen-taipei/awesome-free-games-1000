/**
 * Medusa Slayer Main Entry
 * Game #348
 */
import { MedusaSlayerGame } from "./game";
...
function initGame() {
  game = new MedusaSlayerGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    resistanceDisplay.textContent = state.resistance.toString();
