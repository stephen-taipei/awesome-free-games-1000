/**
 * Golem Master Main Entry
 * Game #339
 */
import { GolemMasterGame } from "./game";
...
function initGame() {
  game = new GolemMasterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    manaDisplay.textContent = state.earthMana.toString();
