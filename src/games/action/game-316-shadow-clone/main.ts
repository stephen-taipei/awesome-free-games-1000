/**
 * Shadow Clone Main Entry
 * Game #316
 */
import { ShadowCloneGame } from "./game";
...
const clonesDisplay = document.getElementById("clones-display")!;
...
function initGame() {
  game = new ShadowCloneGame(canvas);
  game.resize();

  game.setOnStateChange((state) => {
    scoreDisplay.textContent = state.score.toString();
    clonesDisplay.textContent = state.clones.toString();
