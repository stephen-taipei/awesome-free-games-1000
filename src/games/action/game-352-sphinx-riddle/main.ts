/**
 * Sphinx Riddle Main Entry
 * Game #352
 */
import { SphinxRiddleGame } from "./game";
...
function initGame() {
  game = new SphinxRiddleGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    wisdomDisplay.textContent = state.wisdom.toString();
