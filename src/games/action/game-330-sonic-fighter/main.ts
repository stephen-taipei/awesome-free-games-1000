/**
 * Sonic Fighter Main Entry
 * Game #330
 */
import { SonicFighterGame } from "./game";
...
const sonicDisplay = document.getElementById("sonic-display")!;
...
function initGame() {
  game = new SonicFighterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    sonicDisplay.textContent = state.sonic.toString();
