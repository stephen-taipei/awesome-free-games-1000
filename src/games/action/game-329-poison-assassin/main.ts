/**
 * Poison Assassin Main Entry
 * Game #329
 */
import { PoisonAssassinGame } from "./game";
...
const venomDisplay = document.getElementById("venom-display")!;
...
function initGame() {
  game = new PoisonAssassinGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    venomDisplay.textContent = state.venom.toString();
