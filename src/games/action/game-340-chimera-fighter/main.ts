/**
 * Chimera Fighter Main Entry
 * Game #340
 */
import { ChimeraFighterGame } from "./game";
...
function initGame() {
  game = new ChimeraFighterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    powerDisplay.textContent = state.mythicPower.toString();
