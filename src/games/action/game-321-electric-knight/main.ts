/**
 * Electric Knight Main Entry
 * Game #321
 */
import { ElectricKnightGame } from "./game";
...
function initGame() {
  game = new ElectricKnightGame(canvas);
  game.resize();

  game.setOnStateChange((state) => {
    scoreDisplay.textContent = state.score.toString();
    chargeDisplay.textContent = state.charge.toString();
