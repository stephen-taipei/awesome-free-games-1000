/**
 * Cyclops Hunter Main Entry
 * Game #347
 */
import { CyclopsHunterGame } from "./game";
...
function initGame() {
  game = new CyclopsHunterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    focusDisplay.textContent = state.focus.toString();
