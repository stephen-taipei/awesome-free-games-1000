/**
 * Werewolf Fighter Main Entry
 * Game #335
 */
import { WerewolfFighterGame } from "./game";
...
function initGame() {
  game = new WerewolfFighterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    rageDisplay.textContent = state.rage.toString();
