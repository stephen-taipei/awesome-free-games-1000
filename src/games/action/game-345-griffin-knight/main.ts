/**
 * Griffin Knight Main Entry
 * Game #345
 */
import { GriffinKnightGame } from "./game";
...
function initGame() {
  game = new GriffinKnightGame(canvas);
  game.resize();

  document.addEventListener("keydown", (e) => {
    switch (e.key) {
      case "ArrowLeft": case "a": case "A":
        e.preventDefault(); game.setKey("left", true); break;
      case "ArrowRight": case "d": case "D":
        e.preventDefault(); game.setKey("right", true); break;
      case "ArrowUp": case "w": case "W":
        e.preventDefault(); game.setKey("jump", true); break;
      case " ":
        e.preventDefault(); game.setKey("attack", true); break;
      case "e": case "E":
        e.preventDefault(); game.setKey("special", true); break;
    }
  });
