/**
 * Harpy Hunter Main Entry
 * Game #353
 */
import { HarpyHunterGame } from "./game";
...
function initGame() {
  game = new HarpyHunterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    windDisplay.textContent = state.wind.toString();
