/**
 * Psychic Warrior Main Entry
 * Game #331
 */
import { PsychicWarriorGame } from "./game";
...
function initGame() {
  game = new PsychicWarriorGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    energyDisplay.textContent = state.psychicEnergy.toString();
