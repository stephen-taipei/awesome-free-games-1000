import { StickmanWarGame } from './game';
...
document.getElementById('spawn-soldier')?.addEventListener('click', () => game.spawnArcher());
document.getElementById('spawn-tank')?.addEventListener('click', () => game.spawnTank());
