/**
 * Vampire Hunter Main Entry
 * Game #334
 */
import { VampireHunterGame } from "./game";
...
function initGame() {
  game = new VampireHunterGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    bloodDisplay.textContent = state.blood.toString();
