/**
 * Demon Slayer Main Entry
 * Game #336
 */
import { DemonSlayerGame } from "./game";
...
const holyDisplay = document.getElementById("holy-display")!;
...
function initGame() {
  game = new DemonSlayerGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    holyDisplay.textContent = state.holy.toString();
