/**
 * Thunder God Main Entry
 * Game #328
 */
import { ThunderGodGame } from "./game";
...
const thunderDisplay = document.getElementById("thunder-display")!;
...
function initGame() {
  game = new ThunderGodGame(canvas);
  game.resize();
  ...
  game.setOnStateChange((state) => {
    ...
    thunderDisplay.textContent = state.thunder.toString();
